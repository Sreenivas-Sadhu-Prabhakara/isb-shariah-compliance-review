package com.bank.islamic.shariahcompliancereview.model;
...
/**
 * The BIAN control record for this service domain: "Shariah Compliance Case Assessment".
 *
 ...
 * to its asset type (Shariah Compliance Case). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Shariah Compliance Case Assessment";
